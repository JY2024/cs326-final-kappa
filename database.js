...
export function getMyRecipeList(username){
    console.log("getRecipeList: " + username);
    if(username === "John"){
        return [];
    }
    return [{recipeID: 1234, recipe_name: 'Pizza', author: 'not_a_parrot_25'},{recipeID: 1235, recipe_name: 'Soup', author: 'not_a_parrot_25'},{recipeID: 1236, recipe_name: 'Sourdough Bread', author: 'not_a_parrot_25'}];
}
export function getSavedRecipeList(username){
    console.log("getRecipeList: " + username);
    if(username === "John"){
        return [];
    }
    return [{recipeID: 2345, recipe_name: 'Pizza', author: 'Jay'},{recipeID: 3456, recipe_name: 'Soup', author: 'Daksh'},{recipeID: 6789, recipe_name: 'Sourdough Bread', author: 'Bella'}];
}
